...
| --- | --- |
| `harnessed container-run <harness> [path] [--stack <name>] [--fresh]` | Isolated stack on a harness: assembled profile + pod (harness + hatago). With neither `--stack` nor `--recipe`, runs the `default` baseline |
