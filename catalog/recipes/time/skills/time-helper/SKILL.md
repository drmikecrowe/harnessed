...
`America/New_York`) to report the current time. Call `convert_time` to translate a time between
timezones. This skill ships no dependencies. It only documents how to drive the baked
