---
name: wrangler
description: Cloudflare Workers CLI: deploy and manage Workers, KV, R2, D1, Vectorize, Hyperdrive, Workers AI, Containers, Queues, Workflows, Pipelines, Secrets Store. Load before running any `wrangler` command. Prefers Cloudflare docs over pre-trained knowledge.
---
