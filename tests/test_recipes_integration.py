...
# catalog/recipes/beads/PLAN.md "Risks / checks"). The assembler-driven oracle is structurally
# empty for these; verified manually, not by this fast sweep.
NO_CAPABILITY_ORACLE = {"claude_beads"}
