...
| How do I write a Story? What does Gate 1 grade, and what is not wired yet? | [AGENTS.md](AGENTS.md) §Spec-Evidence — Gate 1 runs here; Gate 2 and the layout checker do not |
